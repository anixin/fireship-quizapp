...
import 'package:quizapp3/quiz/quiz_state.dart';
...
import 'package:quizapp3/shared/progress_bar.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            'Congratulations!! You completed ${quiz.title}',
